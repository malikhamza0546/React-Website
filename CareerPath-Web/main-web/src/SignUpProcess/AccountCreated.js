...
const AccountCreated = (props) => {
    localStorage.setItem("navState", 17)
    return (
        <div className="flex flex-col justify-center items-center text-gray-500 w-full">
            ...
            <p className="text-center mt-3">Your profile is ready. Please go to your email and verify your email address. And don't forget to download the CareerPaths app. Happy meeting! 😃</p>
