...
const SelectIndustry = (props) => {
    ...
    const removeIndustry = (id) => {
        axios.delete(`${process.env.REACT_APP_SERVER_PATH}/professional/${jwt_decode(localStorage.getItem("signup_token")).id}/industry/${id}`).then((response) => {
            console.log(response);
    ...
    return (
        <div className="flex flex-col justify-center items-center text-gray-500 w-full">
            <img src="/selectIndustry.png" alt="addVideo" className="w-36" />
