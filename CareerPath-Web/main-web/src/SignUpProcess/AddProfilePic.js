...
const AddProfilePic = (props) => {
    ...
    return (
        <div className="flex flex-col justify-center items-center w-full">
            <img src='profilePic.png' alt="profilePic" className="w-24" />
            <p className="text-2xl font-bold mt-3 text-gray-800">Add your profile photo</p>
            <p className="text-xs mt-3 text-center">Put a face to the name and let your customer's know who they're speaking to</p>
