...
const AddEducation = (props) => {
    ...
    return (
        <div className="flex flex-col justify-center items-center text-gray-500 w-full">
            <img src="/addEducation.png" alt="addVideo" className="w-36" />
            <p className="text-2xl font-bold mt-3 text-gray-700">Education</p>
            <p className="text-xs mt-3">Add details about your relevent qualifications here</p>
            ...
            onClick={() => { props.setNavState(13) }}>Skip</button>
