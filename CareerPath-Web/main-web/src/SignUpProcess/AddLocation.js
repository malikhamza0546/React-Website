...
const AddLocation = (props) => {
    ...
    return (
        <div className="flex flex-col justify-center items-center w-full">
            <img src="location.png" alt="location" className="w-36" />
            <p className="text-2xl font-bold mt-3 text-gray-800">Location</p>
            <p className="text-xs mt-3 text-center">Tell us where you're based so we can match you with customers in your location</p>
            <div className="w-full text-xs font-bold mt-4">
                ...
                <div className="border flex border-gray-300 rounded-lg items-center justify-between py-1 px-2">
                    <input className="text-sm rounded-lg w-full py-2 px-3 text-gray-700  focus:outline-none" id="location" type="text" placeholder="e.g London" value={location} onChange={(e) => {
                        setError(false)
