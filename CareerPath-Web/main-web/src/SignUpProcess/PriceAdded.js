...
const PriceAdded = (props) => {
    ...
    return (
        <div className="flex flex-col justify-center items-center text-gray-500 w-full">
            ...
            <p className="text-2xl font-bold mt-3 text-gray-700">Price Added</p>
            <p className="text-xs mt-3">CareerPaths helps you boost your productivity on a differnet level </p>
            <div className="w-full flex mt-4">
                <div className="w-1/2">
                    ...
                    <div className="flex border border-gray-300 rounded-lg ">
                        ...
                        <input className="text-sm rounded-lg w-full  py-2 px-3 text-gray-700  focus:outline-none" id="firstName" type="text" placeholder="150.00" value={session_15_price}/>
                    </div>
                </div>
                <div className="w-1/2 ml-1">
                    ...
                    <div className="flex border border-gray-300 rounded-lg ">
                        <p className="bg-blue-500 px-4 flex items-center justify-center rounded text-white" style={{backgroundColor:Colors.darkBlue}}>$</p>
                        <input className="text-sm rounded-lg w-full  py-2 px-3 text-gray-700  focus:outline-none" id="30min" type="text" placeholder="300.00" value={session_30_price}/>
                    </div>
                </div>
            </div>
