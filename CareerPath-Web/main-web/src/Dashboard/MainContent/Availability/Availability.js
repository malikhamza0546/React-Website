...
const Availability = (props) => {
    return (
        <div className="bg-white pb-8 mb-4 rounded p-6 mt-6">
        ...
        <div className={props.modal} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <div className='flex flex-col z-20 bg-white rounded p-6'>
                ...
                <div className='flex items-center justify-between mt-4 w-full'>
                    ...
                    <button className='px-5 text-lg py-2 ml-2 text-white rounded-lg bg-red-500 hover:bg-red-800' onClick={deleteA}>Yes</button>
                </div>
            </div>
        </div>
    )
