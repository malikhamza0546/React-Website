...
const YearlyTransactions = ({ transactionsYearly, userType, customerTransactionsYearly }) => {
    return (
        <div className='mt-6'>
            {userType === 'professional' ? transactionsYearly.map(transaction => {
                return (
                    <div>
            ...
            }) : customerTransactionsYearly.map(transaction => {
                return (
                    <div>
                        {console.log(transaction.action, "transaction action")}
                        {transaction.action === 'Refund' ?
