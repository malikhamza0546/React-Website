...
const WeeklyTransactions = ({ transactionsWeekly, userType, customerTransactionsWeekly }) => {
    return (
        <div className='mt-6'>
            {userType === 'professional' ? transactionsWeekly.map(transaction => {
                return (
                    <div>
            ...
            }) : customerTransactionsWeekly.map(transaction => {
                return (
                    <div>
                        {console.log(transaction.action, "transaction action")}
                        {transaction.action === 'Refund' ?
