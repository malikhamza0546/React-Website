...
const BookingRequest = ({ time, prof_firstName, prof_lastName, professionalImage, bookingID,user, setNavState, setBookingNavState, session_duration, backImage }) => {
    const navigate=useNavigate()
    return (
        <div className="text-black hover:shadow-2xl p-2 pt-4 overflow-y-hidden bg-blue-200 rounded-xl flex flex-col items-center h-48  m-2" style={{
            ...
            <div className="flex items-center" >
                <img src={professionalImage} alt="elo0n" className="z-20 w-16 h-16 rounded-full object-cover" />
            </div>
