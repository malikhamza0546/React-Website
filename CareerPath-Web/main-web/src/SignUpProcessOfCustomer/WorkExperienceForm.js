    ...
    return (
        <div className="font-bold text-xs w-full">
            ...
            <div className="my-4 w-full text-xs font-bold">
                ...
                <textarea className="resize-none border border-gray-300 rounded-md  border  w-full h-24 py-3 px-3 text-gray-700  focus:outline-none" id="description" type="text" placeholder="Description"
